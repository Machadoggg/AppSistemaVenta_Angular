...
export class ModalProductoComponent implements OnInit {
  ...
  constructor(
    ...
    //campos del formulario y validación
      ...
      this._productoServicio.guardar(_producto).subscribe({
        next:(data) => {
          if(data.value){
            ...
            this._utilidadServicio.mostrarAlerta("Ne se pudo registrar el producto", "Error")
      ...
      this._productoServicio.editar(_producto).subscribe({
        next:(data) => {
          if(data.value){
            ...
            this._utilidadServicio.mostrarAlerta("Ne se pudo editar el producto","Error") 
        },
        error:(e) => {}
      })
